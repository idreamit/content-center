...
import com.itcrazy.contentcenter.sentineltest.TestControllerBlockHandlerClass;
...
public class TestController {
    ...
    public static void main(String[] args) {
        /* AppClassLoader演示*/
        System.out.println(new UserDTO().getClass().getClassLoader());

        /* ExtensionClassLoader演示*/
        System.out.println(new UserDTO().getClass().getClassLoader().getParent());

        /* BootstrapClassLoader演示*/
        System.out.println(new UserDTO().getClass().getClassLoader().getParent().getParent());
...
//        System.out.println(this.discoveryClient.getServices());
    ...
    @SentinelResource(value = "test-sentinel-api",blockHandler = "block",fallback = "fallback",blockHandlerClass = TestControllerBlockHandlerClass.class)
    public String testSentinelResource(@RequestParam(required = false) String a) {
        // 被保护的业务逻辑
        if (StringUtils.isBlank(a)) {
            throw new IllegalArgumentException("a can't be blanked.");
        }
        return a;
    }
